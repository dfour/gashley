...
public class GashleyBox2dRenderer  {
	...
	public GashleyBox2dRenderer () {
		this(true, true, false, true, false, true);
	}

	public GashleyBox2dRenderer (boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
	...
	public Color SHAPE_NOT_ACTIVE = new Color(0.5f, 0.5f, 0.3f, 0.4f).mul(0.4f);
	public Color SHAPE_STATIC = new Color(0.5f, 0.9f, 0.5f, 0.4f).mul(0.4f);
	public Color SHAPE_KINEMATIC = new Color(0.5f, 0.5f, 0.9f, 0.4f).mul(0.4f);
	public Color SHAPE_NOT_AWAKE = new Color(0.6f, 0.6f, 0.6f, 0.4f).mul(0.4f);
	public Color SHAPE_AWAKE = new Color(0.9f, 0.7f, 0.7f, 0.4f).mul(0.4f);
	public Color JOINT_COLOR = new Color(0.5f, 0.8f, 0.8f, 0.4f).mul(0.4f);
	public Color AABB_COLOR = new Color(1.0f, 0, 1.0f, 0.4f).mul(0.4f);
	public Color VELOCITY_COLOR = new Color(1.0f, 0, 0f, 0.4f).mul(0.4f);
	...
	public static void setAxis (Vector2 axis) {
		GashleyBox2dRenderer.axis = axis;
	}
